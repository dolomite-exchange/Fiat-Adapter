...
| allowedUsStates      | If the US is an allowed region, a list of US states and territories (two letter state code) that are allowed. All others will be blocked. | ['AK', 'AL', 'AR', 'AZ', 'CA', 'CO', 'CT', 'DE', 'FL', 'GA', 'HI', 'ID', 'IL', 'IN', 'IA', 'KS', 'KY', 'LA', 'ME', 'MD', 'MA', 'MI', 'MN', 'MS', 'MO', 'MT', 'NE', 'NV', 'NH', 'NJ', 'NM', 'NY', 'NC', 'ND', 'OH', 'OK', 'OR', 'PA', 'RI', 'SC', 'SD', 'TN', 'TX', 'UT', 'VT', 'VA', 'WA', 'WV', 'WI', 'WY', 'AS', 'DC', 'FM', 'GU', 'MH', 'MP', 'PW', 'PR', 'VI']      |
| blockedUsStates      | If the US is an allowed region, a list of US states and territories (two letter state code) that are blocked. All others will be allowed. | []  what happens if I specify both allowed states and unallowed? Note: suggested re-name. Note: rename.   |
